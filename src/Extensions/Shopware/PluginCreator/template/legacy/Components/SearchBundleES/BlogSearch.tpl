...
namespace <?= $configuration->pluginConfig['namespace']; ?>\<?= $configuration->name; ?>\SearchBundleES;
...
use <?= $configuration->pluginConfig['namespace']; ?>\<?= $configuration->name; ?>\BlogExtension\ESIndexingBundle\Struct\Blog;
