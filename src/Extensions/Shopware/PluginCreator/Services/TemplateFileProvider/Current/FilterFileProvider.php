...
class FilterFileProvider implements FileProviderInterface
{
    ...
    public function getFiles(Configuration $configuration, NameGenerator $nameGenerator)
    {
        ...
        return array(
            ...
            self::CURRENT_DIR . "Components/SearchBundleDBAL/Sorting/RandomSorting.tpl" => "Components/SearchBundleDBAL/Sorting/RandomSorting.php",
            self::CURRENT_DIR . "Components/SearchBundleDBAL/Sorting/RandomSortingHandler.tpl" => "Components/SearchBundleDBAL/Sorting/RandomSortingHandler.php",
